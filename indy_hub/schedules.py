...
INDY_HUB_BEAT_SCHEDULE = {
    'indy-hub-update-all-blueprints': {
        'task': 'indy_hub.tasks.update_all_blueprints',
        'schedule': crontab(minute='*/30'),  # Toutes les 30 minutes
        'options': {'priority': 7}  # Priorité basse pour les mises à jour en arrière-plan
    },
    'indy-hub-update-all-industry-jobs': {
        'task': 'indy_hub.tasks.update_all_industry_jobs',
    ...
    'indy-hub-cleanup-old-jobs': {
        'task': 'indy_hub.tasks.cleanup_old_jobs',
    ...
    'indy-hub-update-type-names': {
        'task': 'indy_hub.tasks.update_type_names',
