...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("indy_hub", "0057_rename_indy_hub_me_buy_esi_con_idx_indy_hub_ma_esi_con_f75c4b_idx_and_more"),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("location_flag", models.CharField(blank=True, db_index=True, max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("name", models.CharField(max_length=255)),
                ("last_resolved", models.DateTimeField(default=django.utils.timezone.now)),
            ],
            options={
