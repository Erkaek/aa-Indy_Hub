...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(default=False, help_text='Whether ESI validation confirmed contract completion'),
        ),
        migrations.AddField(
            model_name='materialexchangebuyorder',
        ...
        migrations.AddField(
            model_name='materialexchangesellorder',
            name='esi_contract_validated',
            field=models.BooleanField(default=False, help_text='Whether ESI validation confirmed contract items'),
        ),
        migrations.AddField(
            model_name='materialexchangesellorder',
            name='esi_validation_checked_at',
