    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='industry_jobs', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Industry Job',
                'verbose_name_plural': 'Industry Jobs',
                'indexes': [models.Index(fields=['character_id', 'status'], name='indy_hub_in_charact_9ec4da_idx'), models.Index(fields=['owner_user', 'start_date'], name='indy_hub_in_owner_u_b59db7_idx'), models.Index(fields=['activity_id', 'status'], name='indy_hub_in_activit_8408d4_idx')],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_updated', models.DateTimeField(auto_now=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('owner_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='blueprints', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Blueprint',
                'verbose_name_plural': 'Blueprints',
                'indexes': [models.Index(fields=['character_id', 'type_id'], name='indy_hub_bl_charact_bfe16f_idx'), models.Index(fields=['owner_user', 'last_updated'], name='indy_hub_bl_owner_u_47cf92_idx')],
            },
        ),
    ]
